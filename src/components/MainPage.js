      ...
      <div className="__all">
        <div className="part1">
          <div>
            <div className="logo_title">
              <img className="logo" alt="logo" src={require('./images/logo2.png')}></img>
            ...
            <div className="check">
              ...
              <DropdownButton id="dropdown-basic-button" title="선택">
                  {information.map((data) => // a 태그를 쓰게 될 경우 a 태그의 기본적인 속성때문에 새로 렌더링이 되기 때문에, Link를 써주어서 새로 렌더링되는 것을 막아주어야 한다.
                      <Dropdown.Item as = { Link } key={data.id} to={`/map/${data.id}`}>
                        {data.name}
                      </Dropdown.Item>
                  )}
                </DropdownButton>
        ...
        <div className="part2">
          ...
          <div className="part2_1">
            ...
            <img src={require('./images/process_1.png')} className="guide_img" alt = "process"></img>
          </div>
          <div className="part2_2">
            ...
            <img src={require('./images/process_2.png')} className="guide_img" alt = "process"></img>
          </div>
          <div className="part2_3">
            ...
            <img src={require('./images/process_3.png')} className="guide_img" alt = "process"></img>
          </div>
        </div>
      </div>
    )
